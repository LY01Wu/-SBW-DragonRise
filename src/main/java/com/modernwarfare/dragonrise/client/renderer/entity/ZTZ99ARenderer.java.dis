...
import com.modernwarfare.dragonrise.client.layer.ZTZ99ALayer;
...
public class ZTZ99ARenderer extends GeoEntityRenderer<ZTZ99AEntity> {
    ...
    public ZTZ99ARenderer(EntityRendererProvider.Context renderManager) {
        ...
        //this.addRenderLayer(new ZTZ99ALayer(this));
        //this.shadowRadius = 0.5f;
    }

    @Override
    public RenderType getRenderType(ZTZ99AEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, ZTZ99AEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(ZTZ99AEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, ZTZ99AEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
