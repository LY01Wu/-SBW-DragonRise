...
import com.modernwarfare.dragonrise.client.model.ZBD04AModel;
...
public class ZBD04ARenderer extends GeoEntityRenderer<ZBD04AEntity> {

    public ZBD04ARenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new ZBD04AModel());
        //this.addRenderLayer(new ZBD04ALayer(this));
        //this.shadowRadius = 0.5f;
    }

    @Override
    public RenderType getRenderType(ZBD04AEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, ZBD04AEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
...
//        this.scaleWidth = scale;
    ...
    @Override
    public void render(ZBD04AEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, ZBD04AEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
